...
public class GuiUtil {
    ...
    public static int getWindowColor(UUID uuid) {
        ...
        switch (uuid.toString()) {
            case "342fc44b-1fd1-4272-a4c3-a98a2df98abc": return 0x3575DF;
            case "cda8edd9-430e-4f6e-a45a-be4566f39c38": return 0xEB8258;
            case "c499a96f-8a69-47c3-8525-0595b6b50f00": return 0x00FF44;
            case "a997ff99-4515-4055-9117-39be3469c9d7": return 0xFFCE3D;
            case "4d03444c-2e0b-4b8e-a445-a2965c907676": return 0x48B6ED;
            default: break;
        }
    ...
    public static class QuintAnimation {
        ...
        public float getState() {
            if (System.currentTimeMillis() - startTime > animationLength) {
                return currentValue;
            }
            double progress = ((double) (System.currentTimeMillis() - startTime)) / animationLength;
